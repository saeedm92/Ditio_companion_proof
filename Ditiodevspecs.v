(*
 * Ditio Device Specifications
 * File: Ditiodevspecs.v
 *
...
(* Don't add to LoC of device specs. Add to spec of lang *)
...
(* Check the camera for the period 100 to 1000*)

Definition n5_cam_check := mkinv uni_r msm_cam_on msm_cam_spec (Int.repr 100) (Int.repr 1000).
